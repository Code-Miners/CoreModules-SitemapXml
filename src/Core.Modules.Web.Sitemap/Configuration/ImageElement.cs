//-----------------------------------------------------------------------
// <copyright file="ImageElement.cs" company="Code Miners Limited">
...
namespace Core.Modules.Web.Sitemap.Configuration
{
    ...
    /// <summary>
    /// The image element maps a single configuration file entry to a strongly
    /// typed object
    /// </summary>
    public class ImageElement : ConfigurationElement
    {
        ...
        internal ImageElement(string name, string value)
        {
            this["name"] = name;
            this["value"] = value;
        }
