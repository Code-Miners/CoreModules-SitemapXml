//-----------------------------------------------------------------------
// <copyright file="ImageSitemap.cs" company="Code Miners Limited">
...
namespace Core.Modules.Web.Sitemap.Model
{
    ...
    public class ImageSitemap : IXmlNamespaceProvider
    {
        /// <summary>
        ...
        public ImageSitemap(IEnumerable<SitemapNode> nodes)
        {
