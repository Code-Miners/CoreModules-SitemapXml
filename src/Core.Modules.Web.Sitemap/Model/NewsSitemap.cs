//-----------------------------------------------------------------------
// <copyright file="NewsSitemap.cs" company="Code Miners Limited">
...
namespace Core.Modules.Web.Sitemap.Model
{
    ...
    /// <summary>
    /// Encapsulates the news sitemap file and references the current protocol standard.
    /// </summary>
    [XmlRoot("urlset", Namespace = XmlNamespaces.Sitemap)]
    public class NewsSitemap : IXmlNamespaceProvider
    {
        /// <summary>
        ...
        public NewsSitemap(IEnumerable<SitemapNode> nodes)
        {
