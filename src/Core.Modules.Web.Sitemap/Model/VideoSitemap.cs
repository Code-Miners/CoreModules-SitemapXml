//-----------------------------------------------------------------------
// <copyright file="VideoSitemap.cs" company="Code Miners Limited">
...
namespace Core.Modules.Web.Sitemap.Model
{
    ...
    public class VideoSitemap : IXmlNamespaceProvider
    {
        /// <summary>
        ...
        public VideoSitemap(IEnumerable<SitemapNode> nodes)
        {
